...
public class RacerServiceImpl implements RacerService {
    ...
    @Autowired
    public RacerServiceImpl(RacerRepository racerRepository, TownRepository townRepository, Gson gson, FileUtil fileUtil, ModelMapper modelMapper, ValidationUtil validationUtil) {
        ...
        Arrays.stream(racerImportDtos)
                .forEach(racerImportDto -> {
                   ...
                   importResult.append(String.format(Constants.SUCCESSFUL_IMPORT_MESSAGE,
                           racerEntity.getClass().getSimpleName(), racerEntity.getName()))
