...
public class RaceEntryServiceImpl implements RaceEntryService {
    ...
    @Autowired
    public RaceEntryServiceImpl(RaceEntryRepository raceEntryRepository, RacerRepository racerRepository, CarRepository carRepository, XmlParser xmlParser, FileUtil fileUtil, ModelMapper modelMapper, ValidationUtil validationUtil) {
