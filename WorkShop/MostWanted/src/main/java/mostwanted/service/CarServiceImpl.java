...
public class CarServiceImpl implements CarService {
    ...
    @Autowired
    public CarServiceImpl(CarRepository carRepository, RacerRepository racerRepository, Gson gson, FileUtil fileUtil, ModelMapper modelMapper, ValidationUtil validationUtil) {
