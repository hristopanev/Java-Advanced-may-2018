...
public class DistrictServiceImpl implements DistrictService {
    ...
    @Autowired
    public DistrictServiceImpl(DistrictRepository districtRepository, TownRepository townRepository, Gson gson, FileUtil fileUtil, ModelMapper modelMapper, ValidationUtil validationUtil) {
    ...
    public String importDistricts(String districtsFileContent) {
        ...
        Arrays.stream(districtImportDtos)
                .forEach(districtImportDto -> {
                    ...
                    importResult.append(String.format(Constants.SUCCESSFUL_IMPORT_MESSAGE, districtEntity.getClass().getSimpleName(),
