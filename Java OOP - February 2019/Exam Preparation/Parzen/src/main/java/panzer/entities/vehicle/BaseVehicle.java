...
public abstract class BaseVehicle implements Vehicle, Modelable {
    ...
    private Assembler vehicleAssebler;
    ...
    protected BaseVehicle(String model, double weight, BigDecimal price, int attack, int defense, int hitPoints) {
        ...
        this.vehicleAssebler = new VehicleAssembler();
    ...
    public double getTotalWeight() {
        return this.vehicleAssebler.getTotalWeight() + this.weight;
    }

    @Override
    public BigDecimal getTotalPrice() {
        return this.vehicleAssebler.getTotalPrice().add(this.price);
    }

    @Override
    public long getTotalAttack() {
        return this.vehicleAssebler.getTotalAttackModification() + this.attack;
    }

    @Override
    public long getTotalDefense() {
        return this.vehicleAssebler.getTotalDefenseModification() + this.defense;
    }

    @Override
    public long getTotalHitPoints() {
        return this.vehicleAssebler.getTotalHitPointModification() + this.hitPoints;
    }
