...
public class BookServiceImpl implements BookService {
    ...
    private final static String BOOKS_FILE_PATH ="D:\\Project\\Java\\Java-Fundamentals\\Databases Frameworks - Hibernate & Spring Data\\Exercise\\SpringDataIntro\\src\\main\\resources\\files\\books.txt";
    ...
    public void seedBook() throws IOException {
        ...
        for (String line : booksFileContent) {
            ...
            book.setAuthor(this.gerRandomAuthor());
            EditionType editionType = EditionType.values()[Integer.parseInt(lineParams[0])];
            book.setEditionType(editionType);

            LocalDate releaseDate = LocalDate.parse(lineParams[1],
    ...
    private Author gerRandomAuthor() {
        Random random = new Random();

        int randomId = random.nextInt((int) (this.authorRepository.count() + 1)) + 1;

       /* Optional<Author> author = this.authorRepository.findById(randomId);
        return author.get();*/
