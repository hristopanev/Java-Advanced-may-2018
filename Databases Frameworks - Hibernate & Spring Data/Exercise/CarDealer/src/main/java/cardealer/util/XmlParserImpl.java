...
public class XmlParserImpl implements XmlParser {
    ...
    @Override
    public <O> void exportToExl(O object, Class<O> objectClass, String path) throws JAXBException {
        JAXBContext context = JAXBContext.newInstance(objectClass);
    ...
    @Override
    public void exportToExl(CarExportRootDTO carExportRootDTO, Class<CarExportRootDTO> carExportRootDTOClass) {
